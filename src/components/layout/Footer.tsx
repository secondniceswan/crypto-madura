      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://bingx.pro/id-id/invite/M82LPG"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm text-text-secondary hover:text-text-primary transition-colors"
                >
              ...
              <li>
                <a
                  href="https://forms.gle/KppDqqaXbRN1AYcX8"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm text-text-secondary hover:text-text-primary transition-colors"
                >
            ...
            <div className="flex gap-3">
              {whatsappUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-text-secondary hover:text-[#25D366] hover:bg-[#25D366]/10 transition-colors"
              ...
              {instagramUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-text-secondary hover:text-[#E1306C] hover:bg-[#E1306C]/10 transition-colors"
        ...
        <div className="mt-8 pt-8 border-t border-glass-border">
          ...
          <p className="text-xs text-text-muted text-center">
            &copy; {new Date().getFullYear()} Crypto Madura. All rights
            reserved.
          </p>
        </div>
      </div>
